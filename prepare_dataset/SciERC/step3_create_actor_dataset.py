...
def create_dataset(train_data, dev_data):
    ...
    with open("dataset/SciERC/train_data/json_files/processed/SciERC-PPO-full.json", "w", encoding="utf-8") as f:
        json.dump(rm_data, f, ensure_ascii=False, indent=4)
    logger.info("Dataset for reward model evaluation has been saved to SciERC-PPO-full.json.")
    logger.info("********** Done **********")
