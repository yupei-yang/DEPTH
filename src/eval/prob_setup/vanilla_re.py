...
def run_relation_eval(pos_eval_data, full_eval_data, actor, tokenizer, args):
    ...
    save_confusion_matrix_csv(d1_confusion, "src/eval/prob_setup/results/d1_confusion_matrix.csv")
    save_confusion_matrix_csv(d2_confusion, "src/eval/prob_setup/results/d2_confusion_matrix.csv")


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--pretrain", type=str, default="meta-llama/Llama-3.1-8B-Instruct")
    ...
    parser.add_argument("--save_dir", type=str, default="src/eval/prob_setup/logs/problem-setup.log")
...
# deepspeed src/eval/prob_setup/vanilla_re.py